...
Euler_file = 'residence_times_flex.pkl'
RK_file = 'residence_times_flex.pkl'

Euler_path = os.path.join(Euler_folder, Euler_file)
RK_path = os.path.join(RK_folder, RK_file)

#Legge i dizionari

Euler_residence_times_dict = joblib.load(Euler_path)
RK_residence_times_dict = joblib.load(RK_path)
...
plt.legend()
plt.savefig('immagini/residence_time_dist_no_noise.png')
...
# Mostra la figura
plt.savefig('immagini/residence_time_increasing_D.png')
